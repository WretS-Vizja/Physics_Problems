...
>
> $T_E = 2\pi\sqrt{\dfrac{L}{g_E}}$
>
> On the Moon, the same pendulum has:
>
> $T_M = 2\pi\sqrt{\dfrac{L}{g_M}}$
>
...
>
> $\dfrac{T_M}{T_E} = \dfrac{2\pi\sqrt{L/g_M}}{2\pi\sqrt{L/g_E}} = \sqrt{\dfrac{g_E}{g_M}}$
>
...
>
> $\dfrac{T_M}{T_E} = \sqrt{\dfrac{g_E}{g_E/6}} = \sqrt{6}$
>
...
> **Idea**
>
> Now we want to design a pendulum with a specific period. We need to invert the period formula to solve for $L$.
 
> **Step 1 – Solve the period formula for $L$**
>
> Starting from $T = 2\pi\sqrt{\dfrac{L}{g}}$, square both sides to remove the square root:
>
...
>
> $L = \dfrac{9.81 \times 1^2}{4\pi^2} = \dfrac{9.81}{4 \times 9.8696} = \dfrac{9.81}{39.478}$
>
...
>
> **Unit check:** $\dfrac{[\text{m/s}^2][\text{s}^2]}{[\text{dimensionless}]} = \text{m}$ ✓
>
